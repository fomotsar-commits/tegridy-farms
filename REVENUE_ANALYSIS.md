...
| 6 | Launchpad mint fee | `TegridyDrop` clones initialized by `TegridyLaunchpad` | **5 %** of mint proceeds (`LAUNCHPAD_FEE_BPS = 500`) | 10 % (`MAX_PROTOCOL_FEE_BPS = 1000`) | Minter (indirect — creator nets 95 %) | Platform fee recipient (treasury) |
