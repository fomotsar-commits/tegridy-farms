...
**Status: design only. No code has been written.** Decide this *before* the audit RFQ goes
out; adding it afterwards means a paid re-review of both trade paths plus a second report.
