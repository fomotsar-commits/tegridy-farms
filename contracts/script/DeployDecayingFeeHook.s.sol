...
contract DeployDecayingFeeHookScript is Script {
    ...
    function run() external {
        ...
        console2.log("2. Publish the schedule on the fact sheet BEFORE the pool is initialized.");
        ...
        console2.log("3. Trade UI: read decaySchedule(key) every block while decaying == true.");
