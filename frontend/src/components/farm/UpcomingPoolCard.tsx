  ...
  return (
    <div className="relative overflow-hidden rounded-xl glass-card-animated card-hover group" style={{ border: '1px solid var(--color-purple-75)' }}>
      <div className="absolute inset-0">
        <img src={pool.art.src} {...artImgProps(pool.art.src)} alt="" loading="lazy" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" style={artStyle(pool.art, pool.artPos)} />
      </div>
