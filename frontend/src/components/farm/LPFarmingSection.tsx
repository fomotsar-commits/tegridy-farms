            ...
            {lpApr !== null ? (
              ...
              <>
                ...
                <span className="text-white/55 text-[10px]">
                  {/* The ORDER is the fix. An unread pool total stays first: it
                      must not invite you to be first on a farm that may be fully
                      subscribed, and it outranks the ended claim too. The ended
                      period comes BEFORE the empty pool — the other way round, a
                      farm paying nothing invited "be the first to stake LP to
                      activate the live APR". Worded as an end, not "between
                      epochs": the Reward Rate tile below says why that reads as a
                      lull. */}
