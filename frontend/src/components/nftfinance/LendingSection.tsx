  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
      {stats.map((s, idx) => (
        ...
        >
          <ArtPanel art={s.art} opacity={1} overlay={DARK_OVERLAY} className="group hover:scale-[1.02] transition-transform duration-300" style={{ transitionTimingFunction: `cubic-bezier(${EASE.join(',')})` }}>
            <div className="p-4">
...
function OfferFilterBar({
  ...
  return (
    <ArtPanel art={pageArt('lending-section', 5)} opacity={1} overlay={DARK_OVERLAY_HEAVY}>
      <div className="p-4">
...
function LendTab({ deployed }: { deployed: boolean }) {
  ...
  return (
    <ArtPanel art={pageArt('lending-section', 6)} opacity={1} overlay={DARK_OVERLAY}>
      ...
      {expanded && (
        <tr>
          <td colSpan={7} className="p-0">
            ...
            >
              <ArtPanel art={pageArt('lending-section', 7)} opacity={1} overlay={DARK_OVERLAY_HEAVY} className="mx-2 mb-2">
                <div className="p-4">
                  {!userAddress ? (
...
function BorrowTab({ deployed, allOffers, offersLoading }: { deployed: boolean; allOffers: Offer[]; offersLoading: boolean }) {
  ...
  return (
    <div className="pt-4 space-y-4">
      ...
      {offersLoading ? (
        <ArtPanel art={pageArt('lending-section', 8)} opacity={1} overlay={DARK_OVERLAY_HEAVY}>
          <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
        ...
        <ArtPanel art={pageArt('lending-section', 10)} opacity={1} overlay={DARK_OVERLAY_HEAVY}>
...
function MyLoansTab({ deployed, allLoans, loansLoading }: { deployed: boolean; allLoans: Loan[]; loansLoading: boolean }) {
  ...
  return (
    <div className="pt-4 space-y-4">
      ...
      {displayed.length === 0 ? (
        <EmptyState
          art={pageArt('lending-section', 12)}
