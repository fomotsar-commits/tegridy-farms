...
const DARK_OVERLAY = 'rgba(6, 12, 26, 0.70)';
const DARK_OVERLAY_HEAVY = 'rgba(6, 12, 26, 0.76)';
const SHIMMER_BG =
...
function EmptyState({
  ...
  return (
    <ArtPanel artSrc={artSrc} opacity={0.28} overlay="rgba(6,12,26,0.85)">
      ...
      <div className="filter blur-[2px] opacity-40 pointer-events-none select-none" aria-hidden="true">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
          {['12', '3', '1.50', '24.5000'].map((val, i) => (
            <ArtPanel key={i} artSrc={ART.forestScene.src} opacity={0.28}>
              <div className="p-4">
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
      {stats.map((s, idx) => (
        ...
        >
          <ArtPanel artSrc={ART.forestScene.src} opacity={0.28} overlay={DARK_OVERLAY} className="group hover:scale-[1.02] transition-transform duration-300" style={{ transitionTimingFunction: `cubic-bezier(${EASE.join(',')})` }}>
            <div className="p-4">
...
function OfferFilterBar({
  ...
  return (
    <ArtPanel artSrc={ART.porchChill.src} opacity={0.28} overlay={DARK_OVERLAY_HEAVY}>
      <div className="p-4">
...
function LendTab({ deployed }: { deployed: boolean }) {
  ...
  return (
    <ArtPanel artSrc={ART.mfersHeaven.src} opacity={0.28} overlay={DARK_OVERLAY}>
      ...
      {expanded && (
        <tr>
          <td colSpan={7} className="p-0">
            ...
            >
              <ArtPanel artSrc={ART.apeHug.src} opacity={0.28} overlay={DARK_OVERLAY_HEAVY} className="mx-2 mb-2">
                <div className="p-4">
                  {!userAddress ? (
  ...
  return (
    <div className="pt-4 space-y-4">
      ...
      {sortedOffers.length === 0 && count === 0 ? (
        ...
        <ArtPanel artSrc={ART.poolParty.src} opacity={0.28} overlay={DARK_OVERLAY_HEAVY}>
...
function PnlSummaryCard({
  ...
  return (
    <ArtPanel artSrc={ART.swordOfLove.src} opacity={0.30} overlay="rgba(6,12,26,0.85)">
      <div className="p-5">
  ...
  return (
    <div className="pt-4 space-y-4">
      ...
      {displayed.length === 0 ? (
        ...
        <ArtPanel artSrc={ART.swordOfLove.src} opacity={0.28} overlay={DARK_OVERLAY_HEAVY}>
          <div className="p-4">
...
export function LendingSection({ address: propAddress }: { address?: string }) {
  ...
  return (
    <section className="w-full space-y-6">
      ...
      {!deployed && (
        <ArtPanel artSrc={ART.smokingDuo.src} opacity={0.28} overlay="rgba(6,12,26,0.85)">
