  ...
  return (
    <div className="grid grid-cols-3 gap-3 sm:gap-4 mb-8">
      {stats.map((s, i) => (
        ...
        >
          <ArtCard art={ART.boxingRing} opacity={0.70} overlay="rgba(6,12,26,0.30)">
...
function BuySellPanel({ deployed }: { deployed: boolean }) {
  ...
  return (
    <ArtCard art={ART.poolParty} opacity={0.70} overlay="rgba(6,12,26,0.30)" className="rounded-2xl">
      <div className="p-6">
        ...
        {validCollection && hasPool && spotNum > 0 && (
          <motion.div
            ...
            className="mb-5"
          >
            <ArtCard art={ART.beachSunset} opacity={0.70} overlay="rgba(6,12,26,0.30)" border="rgba(16,185,129,0.08)">
              <div className="p-4">
...
function TradeHistory() {
  return (
    <ArtCard art={ART.chaosScene} opacity={0.70} overlay="rgba(6,12,26,0.30)" border="rgba(139,92,246,0.08)">
...
function PoolExplorer({ deployed }: { deployed: boolean }) {
  ...
  return (
    <ArtCard art={ART.jungleDark} opacity={0.70} overlay="rgba(6,12,26,0.30)" className="rounded-2xl">
      <div className="p-6">
        ...
        {!validSearch && (
          <ArtCard art={ART.jungleDark} opacity={0.70} overlay="rgba(6,12,26,0.30)" border="rgba(255,255,255,0.04)">
      ...
      <AnimatePresence mode="wait">
        {step === 1 && (
          <motion.div
            ...
            exit={{ opacity: 0, x: -20 }}
          >
            <ArtCard art={ART.mumuBull} opacity={0.70} overlay="rgba(6,12,26,0.30)" className="rounded-2xl">
              <div className="p-6">
          ...
          >
            <ArtCard art={ART.mumuBull} opacity={0.70} overlay="rgba(6,12,26,0.30)" className="rounded-2xl">
              <div className="p-6">
                ...
                {/* Summary Card */}
                <ArtCard art={ART.busCrew} opacity={0.70} overlay="rgba(6,12,26,0.30)" border="rgba(16,185,129,0.10)">
                  <div className="p-5">
...
function MyPoolsTab({ deployed }: { deployed: boolean }) {
  ...
  if (!address) {
    return (
      <ArtCard art={ART.wrestler} opacity={0.70} overlay="rgba(6,12,26,0.30)" className="rounded-2xl max-w-md mx-auto">
  ...
  return (
    <div className="space-y-6">
      {/* Earnings Summary */}
      <ArtCard art={ART.wrestler} opacity={0.70} overlay="rgba(6,12,26,0.30)" className="rounded-2xl">
        <div className="p-5">
      ...
      {/* Add Pool Input */}
      <ArtCard art={ART.busCrew} opacity={0.70} overlay="rgba(6,12,26,0.30)" className="rounded-2xl">
        <div className="p-5">
      ...
      {trackedPools.length === 0 ? (
        <ArtCard art={ART.wrestler} opacity={0.70} overlay="rgba(6,12,26,0.30)" border="rgba(255,255,255,0.04)" className="rounded-2xl">
...
function ComingSoon() {
  ...
  return (
    <div className="max-w-xl mx-auto">
      <ArtCard art={ART.poolParty} opacity={0.70} overlay="rgba(6,12,26,0.30)" border="rgba(16,185,129,0.10)" className="rounded-2xl">
        <div className="p-8 sm:p-10">
          ...
          <div className="relative z-10">
            ...
            {/* Blurred Preview */}
            <ArtCard art={ART.beachSunset} opacity={0.70} overlay="rgba(6,12,26,0.30)" border="rgba(255,255,255,0.04)" className="rounded-xl mb-8">
