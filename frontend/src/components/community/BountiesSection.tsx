...
export function BountiesSection() {
  ...
  }, [isSuccess, isTxError, isReverted, isReceiptUnreadable, writeError, refetchCount, refetchPosted, refetchPaidOut, refetchPayout, refetchRefund, refetchBounties, reset, txHash, chainId]);
