...
// A dead link is worse than none, and CI now asks Discord about every invite the site
// ships (scripts/verify-discord-invites.mjs), so one can only come back live.
