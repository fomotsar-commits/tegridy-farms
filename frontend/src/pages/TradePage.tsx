    ...
    <div className="-mt-14 relative min-h-screen">
      ...
      <div className="relative z-10 max-w-[600px] mx-auto px-4 md:px-6 pt-20 pb-28 md:pb-12">
        ...
        {tab === 'swap' && (
          <m.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="relative glass-card rounded-2xl overflow-hidden" style={{ border: '1px solid var(--color-purple-12)' }}>
            <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
              <img src={ART.chaosScene.src} alt="" className="w-full h-full object-cover opacity-100" style={{ objectPosition: 'center 15%' }} loading="lazy" />
            </div>
        ...
        {tab === 'dca' && (
          <m.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="relative glass-card rounded-2xl overflow-hidden" style={{ border: '1px solid var(--color-purple-12)' }}>
            <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
              <img src={ART.danceNight.src} alt="" className="w-full h-full object-cover opacity-100" loading="lazy" />
            </div>
        ...
        {tab === 'limit' && (
          <m.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="relative glass-card rounded-2xl overflow-hidden" style={{ border: '1px solid var(--color-purple-12)' }}>
            <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
              <img src={ART.wrestler.src} alt="" className="w-full h-full object-cover opacity-100" loading="lazy" />
            </div>
            <div className="relative">
              <LimitOrderTab />
            </div>
