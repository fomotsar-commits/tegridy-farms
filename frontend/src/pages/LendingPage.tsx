      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-4 md:px-6 pt-24 pb-16">
        ...
        {!isConnected ? (
          <motion.div
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(13,21,48,0.6), rgba(6,12,26,0.8))',
          ...
          >
            ...
            <p className="text-white/60 mb-5 text-[14px]">Connect your wallet to access NFT Finance</p>
            <ConnectButton />
          </motion.div>
        ) : (
          <>
  ...
  return (
    <div className="space-y-4 animate-pulse">
      <div className="grid grid-cols-3 gap-4">
        {[1, 2, 3].map(i => (
          <div key={i} className="rounded-xl p-5" style={{ background: 'rgba(13,21,48,0.4)', border: '1px solid rgba(255,255,255,0.04)' }}>
            <div className="h-3 rounded w-16 mx-auto mb-2" style={{ background: 'rgba(255,255,255,0.06)' }} />
            <div className="h-7 rounded w-14 mx-auto" style={{ background: 'rgba(255,255,255,0.08)' }} />
          </div>
        ))}
      </div>
      <div className="rounded-2xl p-6" style={{ background: 'rgba(13,21,48,0.4)', border: '1px solid rgba(255,255,255,0.04)' }}>
