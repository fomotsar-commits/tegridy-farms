...
function CollectionCard({
  ...
  return (
    <motion.div {...fadeUp}>
      <ArtCard art={ART.galleryCollage} opacity={0.70} overlay="rgba(6,12,26,0.30)" className={`cursor-pointer transition-all duration-300 group ${
        isActive
...
function OwnerAdminPanel({ dropAddress, deployed }: { dropAddress: string; deployed: boolean }) {
  ...
  return (
    <ArtCard art={ART.roseApe} opacity={0.70} overlay="rgba(6,12,26,0.30)" className="mt-6">
      <button
...
function CreatorRevenueDashboard({ drop }: { drop: ReturnType<typeof useNFTDrop> }) {
  ...
  return (
    <ArtCard art={ART.roseApe} opacity={0.70} overlay="rgba(6,12,26,0.30)" className="mb-6">
...
function LiveMintFeed() {
  ...
  return (
    <ArtCard art={ART.danceNight} opacity={0.70} overlay="rgba(6,12,26,0.30)" className="mb-6">
      <h3 className="text-emerald-400 font-semibold tracking-wide uppercase text-[11px] mb-4">
        Live Mint Feed
      </h3>
...
function CollectionDetail({
  ...
  return (
    ...
    >
      {/* Hero */}
      <ArtCard art={ART.beachVibes} opacity={0.70} overlay="rgba(6,12,26,0.30)" className="rounded-2xl mb-0">
        <div className="p-1 sm:p-3">
          ...
          {/* Paused empty state */}
          {drop.currentPhase === 0 && (
            <ArtCard art={ART.towelieWindow} opacity={0.70} overlay="rgba(6,12,26,0.30)" className="mb-6">
          ...
          {/* Mint Interface */}
          <ArtCard art={ART.danceNight} opacity={0.70} overlay="rgba(6,12,26,0.30)">
...
function CreateCollectionForm({ onCreated, deployed }: { onCreated: () => void; deployed: boolean }) {
  ...
  return (
    <motion.div
      ...
      className="mb-8"
    >
      <ArtCard art={ART.chaosScene} opacity={0.70} overlay="rgba(6,12,26,0.30)" className="rounded-2xl">
        <div className="p-1 sm:p-3">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-8">
            ...
            <div className="hidden lg:block">
              ...
              <ArtCard art={ART.galleryCollage} opacity={0.70} overlay="rgba(6,12,26,0.30)" className="mt-1.5">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-3">
...
function ComingSoonPanel() {
  return (
    <motion.div className="max-w-2xl mx-auto text-center" {...fadeUp}>
      <ArtCard art={ART.jungleBus} opacity={0.70} overlay="rgba(6,12,26,0.30)" className="rounded-2xl mb-8">
      ...
      >
        ...
        {!embedded && (
          <motion.div className="text-center mb-10" {...fadeUp}>
            <ArtCard art={ART.jbChristmas} opacity={0.70} overlay="rgba(6,12,26,0.30)" className="inline-block rounded-2xl px-2 py-1 mb-0">
          ...
          <>
            ...
            >
              <div className="flex gap-3">
                <ArtCard art={ART.jbChristmas} opacity={0.70} overlay="rgba(6,12,26,0.30)" className="rounded-xl">
            ...
            {collectionIds.length === 0 ? (
              <motion.div {...fadeUp}>
                <ArtCard art={ART.towelieWindow} opacity={0.70} overlay="rgba(6,12,26,0.30)" className="rounded-2xl">
