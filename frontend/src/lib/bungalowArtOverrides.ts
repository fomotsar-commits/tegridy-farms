...
export const BUNGALOW_ART_OVERRIDES: Record<string, ArtOverride> = {
  ...
  "bayla|dashboard:0": { artId: "bayla-18", objectPosition: "41% 42%" },
  "bayla|dashboard:1": { artId: "bayla-19", objectPosition: "53% 0%" },
  ...
  "bayla|home:2": { artId: "bayla-21", objectPosition: "73% 41%" },
  ...
  "bayla|trade:0": { artId: "bayla-12", objectPosition: "40% 15%" },
