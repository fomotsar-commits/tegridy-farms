...
// V3 Features — NOT YET DEPLOYED (update after mainnet deployment)
export const TEGRIDY_LENDING_ADDRESS = '0x0000000000000000000000000000000000000000' as const;
export const TEGRIDY_LAUNCHPAD_ADDRESS = '0x0000000000000000000000000000000000000000' as const;
export const TEGRIDY_NFT_POOL_FACTORY_ADDRESS = '0x0000000000000000000000000000000000000000' as const;
