...
export const ART = {
  ...
  card01: { id: 'card01', src: '/art/new/G1bssH3bEAA-oaQ.jpg', title: 'Island Art #01', description: 'Fresh drop for the cards' },
  card02: { id: 'card02', src: '/art/new/G72tTUZaYAAw6k2.jpg', title: 'Island Art #02', description: 'Fresh drop for the cards' },
  card03: { id: 'card03', src: '/art/new/GUj0hx3bgAAC9mT.jpg', title: 'Island Art #03', description: 'Fresh drop for the cards' },
  card04: { id: 'card04', src: '/art/new/GYaqVixbQAAGVQO.jpg', title: 'Island Art #04', description: 'Fresh drop for the cards' },
  card05: { id: 'card05', src: '/art/new/GbMURmKWwAAkK0J.jpg', title: 'Island Art #05', description: 'Fresh drop for the cards' },
  card06: { id: 'card06', src: '/art/new/Gh07bQtacAA_iu8.jpg', title: 'Island Art #06', description: 'Fresh drop for the cards' },
  card07: { id: 'card07', src: '/art/new/GhD4TNeXwAAzS6k.jpg', title: 'Island Art #07', description: 'Fresh drop for the cards' },
  card08: { id: 'card08', src: '/art/new/GhL34WubIAAEO83.jpg', title: 'Island Art #08', description: 'Fresh drop for the cards' },
  card09: { id: 'card09', src: '/art/new/GjKSLtSW4AAzyc1.jpg', title: 'Island Art #09', description: 'Fresh drop for the cards' },
  card10: { id: 'card10', src: '/art/new/Gw0FQCxakAArz_-.jpg', title: 'Island Art #10', description: 'Fresh drop for the cards' },
  card11: { id: 'card11', src: '/art/new/Gxn5T7DawAAaQHH.jpg', title: 'Island Art #11', description: 'Fresh drop for the cards' },
  card12: { id: 'card12', src: '/art/new/HI0in14XUAAZN1A.jpg', title: 'Island Art #12', description: 'Fresh drop for the cards' },
  card13: { id: 'card13', src: '/art/new/HIIZWP_aYAEiqOT.jpg', title: 'Island Art #13', description: 'Fresh drop for the cards' },
  card14: { id: 'card14', src: '/art/new/HIywbbyXMAAA0nz.jpg', title: 'Island Art #14', description: 'Fresh drop for the cards' },
  card15: { id: 'card15', src: '/art/new/HJc-bSLaEAApun5.jpg', title: 'Island Art #15', description: 'Fresh drop for the cards' },
  card16: { id: 'card16', src: '/art/new/HMtD8ANbgAAVNv3.jpg', title: 'Island Art #16', description: 'Fresh drop for the cards' },
  card17: { id: 'card17', src: '/art/new/HNajJH8aoAAquGw.jpg', title: 'Island Art #17', description: 'Fresh drop for the cards' },
  card18: { id: 'card18', src: '/art/new/IMG_2754.jpg', title: 'Island Art #18', description: 'Fresh drop for the cards' },
  card19: { id: 'card19', src: '/art/new/IMG_2755.jpg', title: 'Island Art #19', description: 'Fresh drop for the cards' },
  card20: { id: 'card20', src: '/art/new/IMG_2760.jpg', title: 'Island Art #20', description: 'Fresh drop for the cards' },
  card21: { id: 'card21', src: '/art/new/IMG_2761.jpg', title: 'Island Art #21', description: 'Fresh drop for the cards' },
  card22: { id: 'card22', src: '/art/new/IMG_2763.jpg', title: 'Island Art #22', description: 'Fresh drop for the cards' },
  card23: { id: 'card23', src: '/art/new/IMG_2764.jpg', title: 'Island Art #23', description: 'Fresh drop for the cards' },
  card24: { id: 'card24', src: '/art/new/IMG_2765.jpg', title: 'Island Art #24', description: 'Fresh drop for the cards' },
  card25: { id: 'card25', src: '/art/new/IMG_2766.jpg', title: 'Island Art #25', description: 'Fresh drop for the cards' },
  card26: { id: 'card26', src: '/art/new/IMG_2767.jpg', title: 'Island Art #26', description: 'Fresh drop for the cards' },
