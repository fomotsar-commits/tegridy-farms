...
// The package's own icon module (dist/trustWallet-*.js), byte-identical. Lives
// in walletIcons.ts because the Solana connect modal shows the same mark and
// must not import this file (it would drag wagmi + RainbowKit into that chunk).
